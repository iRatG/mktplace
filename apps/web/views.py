...
def landing(request):
    ...
    context = {
        ...
        "blogger_features": [
            ...
            {"icon": "💳", "title": "Вывод на карту", "desc": "От 500 ₽, обработка в течение 3 рабочих дней"},
        ...
        "faq_items": [
            ...
            {"q": "Как вывести заработанные деньги?", "a": "В разделе «Кошелёк» подайте заявку на вывод (от 500 ₽). Обрабатывается в течение 3 рабочих дней."},
